...
namespace WizardBot
{
    public class Bot
    {
        ...
        public string Run()
        {
            ...
            var myBuildings = new List<GameMapPosition>();
        ...
        public string GetValidAttackCommand(int yCoordinate, List<GameMapPosition> myBuildings)
        {
        ...
        public string GetRandomCommand(List<GameMapPosition> myBuildings)
        {
        ...
        private List<int> GetEnemyBuildingRows(List<GameMapPosition> opponentAttackBuildings,
            List<GameMapPosition> myDefenseBuildings)
        {
        ...
        private List<GameMapPosition> GetBuildings(PlayerType playerType, BuildingType buildingType)
        {
            var list = new List<GameMapPosition>();
